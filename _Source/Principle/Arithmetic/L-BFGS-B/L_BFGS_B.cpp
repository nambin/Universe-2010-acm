...
void L_BFGS_B::funcgrad(const ap::real_1d_array& x, double& f, ap::real_1d_array& g){
}
...
void L_BFGS_B::lbfgsbminimize(const int& n,
					const int& m,
					ap::real_1d_array& x,
					const double& epsg,
					const double& epsf,
...
void L_BFGS_B::lbfgsbactive(const int& n,
				  const ap::real_1d_array& l,
				  const ap::real_1d_array& u,
				  const ap::integer_1d_array& nbd,
				  ap::real_1d_array& x,
...
void L_BFGS_B::lbfgsbbmv(const int& m,
...
void L_BFGS_B::lbfgsbcauchy(const int& n,
...
void L_BFGS_B::lbfgsbcmprlb(const int& n,
				  const int& m,
				  const ap::real_1d_array& x,
				  const ap::real_1d_array& g,
				  const ap::real_2d_array& ws,
...
void L_BFGS_B::lbfgsberrclb(const int& n,
				  const int& m,
				  const double& factr,
				  const ap::real_1d_array& l,
				  const ap::real_1d_array& u,
...
void L_BFGS_B::lbfgsbformk(const int& n,
				 const int& nsub,
...
void L_BFGS_B::lbfgsbformt(const int& m,
				 ap::real_2d_array& wt,
				 const ap::real_2d_array& sy,
...
void L_BFGS_B::lbfgsbfreev(const int& n,
				 int& nfree,
				 ap::integer_1d_array& index,
				 int& nenter,
				 int& ileave,
...
void L_BFGS_B::lbfgsbhpsolb(const int& n,
				  ap::real_1d_array& t,
				  ap::integer_1d_array& iorder,
				  const int& iheap)
{
...
void L_BFGS_B::lbfgsblnsrlb(const int& n,
				  const ap::real_1d_array& l,
				  const ap::real_1d_array& u,
				  const ap::integer_1d_array& nbd,
				  ap::real_1d_array& x,
...
void L_BFGS_B::lbfgsbmatupd(const int& n,
				  const int& m,
				  ap::real_2d_array& ws,
				  ap::real_2d_array& wy,
				  ap::real_2d_array& sy,
...
void L_BFGS_B::lbfgsbprojgr(const int& n,
				  const ap::real_1d_array& l,
				  const ap::real_1d_array& u,
				  const ap::integer_1d_array& nbd,
				  const ap::real_1d_array& x,
...
void L_BFGS_B::lbfgsbsubsm(const int& n,
				 const int& m,
				 const int& nsub,
				 const ap::integer_1d_array& ind,
				 const ap::real_1d_array& l,
...
void L_BFGS_B::lbfgsbdcsrch(const double& f,
				  const double& g,
				  double& stp,
				  const double& ftol,
				  const double& gtol,
...
void L_BFGS_B::lbfgsbdcstep(double& stx,
				  double& fx,
				  double& dx,
				  double& sty,
				  double& fy,
...
bool L_BFGS_B::additionallbfgsbstoppingcriterion(int iter,
									   const ap::real_1d_array& x,
									   double f,
									   const ap::real_1d_array& g)
{
...
bool L_BFGS_B::lbfgsbdpofa(ap::real_2d_array& a, const int& n)
{
	bool result;
	double t;
	double s;
...
void L_BFGS_B::lbfgsbdtrsl(ap::real_2d_array& t,
				 const int& n,
				 ap::real_1d_array& b,
				 const int& job,
				 int& info)
...
void L_BFGS_B::lbfgsbnewiteration(const ap::real_1d_array& x,
						double f,
						const ap::real_1d_array& g){
